    ...
    <!-- <div class="home">
        ...
        <?php if(!is_connected()) { ?>
            <div class="d_flex justify_content_center align_items_center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--material-symbols" width="15" height="15" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M12 14.975q-.2 0-.387-.075q-.188-.075-.313-.2l-4.6-4.6q-.275-.275-.275-.7q0-.425.275-.7q.275-.275.7-.275q.425 0 .7.275l3.9 3.9l3.9-3.9q.275-.275.7-.275q.425 0 .7.275q.275.275.275.7q0 .425-.275.7l-4.6 4.6q-.15.15-.325.212q-.175.063-.375.063Z"></path></svg>
            </div>
               <?php }else{ ?>
            <img src="<?= URL.$_SESSION['avatar'] ?>" alt="Profil_<?= $_SESSION['avatar'] ?>">
        <?php } ?>
        ...
        <?php } else { ?>
            ...
            <a href="<?= URL ?>logout" class="btn_profil m_5">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--material-symbols" width="32" height="32" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M3 13v-2h8.65L9.1 8.45L10.5 7l5 5l-5 5l-1.4-1.45L11.65 13Zm2 2v4h14V5H5v4H3V5q0-.825.587-1.413Q4.175 3 5 3h14q.825 0 1.413.587Q21 4.175 21 5v14q0 .825-.587 1.413Q19.825 21 19 21H5q-.825 0-1.413-.587Q3 19.825 3 19v-4Z"></path></svg>
                Déconnexion
                </a>
         <?php } ?>
        </div>
