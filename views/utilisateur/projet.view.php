    ...
    <div class="card_container text_center w_100 d_flex justify_content_center">
        ...
        <?php foreach ($projets as $projet) : ?>
            ...
            <div class="card card_projet w_30 br_10 p_15 m_10 d_flex flex_column ">
                <i class="fa-solid fa-pencil btn_update_card"></i>
                ...
                <div class="d_flex justify_content_around">
                    ...
                    <form class=" form_description_projet d_flex flex_column align_items_center" action="<?= URL ?>user/projet/update/description_projet/<?= $projet->getId() ?>" method="POST">
                ...
                <div class="d_flex justify_content_around ">
                    ...
                    <div class="p_10">nombre d'année(s) : <?= $projet->getDuree() ?> <?php if ($projet->getDuree() > 1) {
                                                                                            echo "ans";
                                                                                        } else {
                                                                                            echo "an";
                                                                                        } ?></div>
